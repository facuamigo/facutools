...
class DatastoreManager:
    def __init__(self, credentials):
        ...
        self.documents_client = discoveryengine.DocumentServiceClient(credentials=credentials)
    ...
    def get_datastore(self, data_store_name: str):
        ...
        return self.datastore_client.get_data_store(request=request)
    
    def list_datastores(self, project_name: str):
        request = discoveryengine.ListDataStoresRequest(
            parent=f"projects/{project_name}/global/collections/default_collection",
        )
